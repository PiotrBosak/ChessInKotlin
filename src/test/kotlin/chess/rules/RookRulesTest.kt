...
class RookRulesTest {
    ...
    fun whiteRookCaptures() {
        ...
        board.makeMoveWithoutCheckingMate(rookStartingTile, rookFirstDest)
        board.makeMoveWithoutCheckingMate(rookFirstDest, rookSecondDest)
        board.makeAttackWithoutCheckingMate(rookSecondDest, rookThirdDest)
        board.makeAttackWithoutCheckingMate(rookThirdDest, rookFourthDest)
        board.makeAttackWithoutCheckingMate(rookFourthDest, rookFifthDest)
